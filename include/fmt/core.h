...
namespace detail {
// A type-erased reference to an std::locale to avoid heavy <locale> src.
class locale_ref {
 private:
...
template <typename OutputIt, typename Char> class basic_format_context {
 ...
 public:
  ...
  /**
   ...
   stored in the object so make sure they have appropriate lifetime.
   */
...
template <typename Context> class basic_format_args {
 ...
 private:
  ...
  union {
    ...
    // data is actually copied to stack. It saves ~10% on the bloat test_basic_allocator.
